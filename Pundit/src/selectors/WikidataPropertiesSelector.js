...
/**
  ...
  * TODO TODO TODO TODO 
  */
dojo.provide("pundit.selectors.WikidataPropertiesSelector");
dojo.declare("pundit.selectors.WikidataPropertiesSelector", pundit.selectors.SelectorBase, {
        ...
        dojo.io.script.get({
            ...
            load: function( response ) {
                if ( response.success == 1 ) {
                    ...
                    self.log('Loaded search term '+term+': '+self.requests[term].len+' properties');
